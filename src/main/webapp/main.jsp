...
<div class="container">
  ...
  <a href="category_philosophy.jsp">
  	<div class="category-box" style="background-image:url('resources/philosophy.jpg'); background-position: center 30%;">
  ...
  <a href="category_life.jsp">
    <div class="category-box" style="background-image:url('resources/life.jpg'); background-position: center 20%;">
...
<div class="quote-box">
  <%
    String recentQuote = (String) session.getAttribute("recentQuoteText");
  %>
  <%= recentQuote != null ? recentQuote : "최근 생성된 명언이 표시됩니다." %>
</div>

<%
  String recentImage = (String) session.getAttribute("recentImageUrl");
  if (recentImage != null && !recentImage.trim().equals("")) {
%>
<div style="text-align:center; margin: 20px auto; width: 90%;">
  <img src="<%= recentImage %>" alt="최근 명언 이미지" 
       style="max-width: 400px; max-height: 200px; border-radius: 8px; border: 2px solid #000;">
  <p style="font-size: 14px; color: #666; margin-top: 5px;">최근 생성된 명언 이미지</p>
</div>
<% } %>
