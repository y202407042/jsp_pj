...
body {
  min-height: 100vh;
  display: flex;
  flex-direction: column;   /* 헤더-본문-푸터 세로 배치 */
  background: #ffffff;
}
...
.header {
  ...
  color: #ffffff;
  justify-content: space-between; /* 로고와 메뉴 좌우 배치 */
}
...
.main-image {
  max-width: 75vw;  /* 뷰포트 너비 75% 제한 */
  max-height: 70vh; /* 뷰포트 높이 70% 제한 */
  object-fit: contain;
  display: block;
